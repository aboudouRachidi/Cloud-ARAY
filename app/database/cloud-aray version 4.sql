...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 28 Octobre 2016 à 18:00
...
(8, 'Disques 08', 3, '2016-10-28 01:37:29', 1),
(9, 'Disques 09', 3, '2016-10-28 13:14:23', 1),
(10, 'Disques 10', 3, '2016-10-28 13:18:19', 1);
...
CREATE TRIGGER `deleteDisque` BEFORE DELETE ON `disque` FOR EACH ROW BEGIN
    ...
    DELETE FROM message WHERE message.idDisque=OLD.id;
...
(8, 1, '2016-10-28 01:37:38'),
(9, 2, '2016-10-28 13:14:35'),
(10, 3, '2016-10-28 13:18:27');
...
(4, 'djbernstein', 'djbernstein@gmail.com', 'aa3d2fe4f6d301dbd6b8fb2d2fddfb7aeebf3bec53ffff4b39a0967afa88c609', 'Bernstein', 'Daniel J.', '0612344444', 1, '2016-03-26 19:09:32', 1),
(5, 'linus.torvals', 'linus.torvals@gmail.com', 'e7042ac7d09c7bc41c8cfa5749e41858f6980643bc0db1a83cc793d3e24d3f77', 'Torvals', 'Linus', NULL, 1, '2016-03-27 19:09:32', 1);
